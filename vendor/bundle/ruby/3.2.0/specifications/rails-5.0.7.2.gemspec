...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<actionmailer>.freeze, ["= 5.0.7.2"])
  s.add_runtime_dependency(%q<activejob>.freeze, ["= 5.0.7.2"])
  s.add_runtime_dependency(%q<actioncable>.freeze, ["= 5.0.7.2"])
  s.add_runtime_dependency(%q<railties>.freeze, ["= 5.0.7.2"])
